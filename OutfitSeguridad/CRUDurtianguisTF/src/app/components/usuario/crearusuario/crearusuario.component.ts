...
export class CrearusuarioComponent implements OnInit {
  ...
  insertar(): void {
    if (this.form.valid) {
      ...
      const salt = bcrypt.genSaltSync(12); // Genera un salt
      const hashedPassword = bcrypt.hashSync(this.form.value.hpassword, salt); // Encripta la contraseña
      ...
      this.usua.password= hashedPassword;
