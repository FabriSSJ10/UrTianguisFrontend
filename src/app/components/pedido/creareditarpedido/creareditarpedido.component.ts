...
@Component({
  ...
  imports: [MatButtonModule,
    ...
    ReactiveFormsModule,
    MatSelectModule,
    MatDatepickerModule, CommonModule, MatNativeDateModule],
...
export class CreareditarpedidoComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.form = this.formBuilder.group({
      ...
      hfecha_solicitud: [new Date(), Validators.required],
      hfecha_entrega: ['', [Validators.required, this.validarFechaFutura]],
    ...
    if (this.edicion) {
      this.pS.listId(this.id).subscribe((data) => {
        this.form = new FormGroup({
          ...
          hpa: new FormControl(data.pa.id_pago),
          hus: new FormControl(data.us.id_usuario),
          hno: new FormControl(data.no.id_notificacion),
        });
      });
    }
  }
